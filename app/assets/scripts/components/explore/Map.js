...
class Map extends React.Component {
  ...
  initMap () {
    ...
    this.map.on('load', () => {
      ...
      const sourceLayer = 'somaliland-cluster';
      this.map.addSource(gepFeaturesSourceId, {
        type: 'vector',
        tiles: ['/geoserver/gwc/service/wmts?REQUEST=GetTile&SERVICE=WMTS&VERSION=1.0.0&LAYER=geonode:somaliland-cluster&STYLE=&TILEMATRIX=EPSG:3857:{z}&TILEMATRIXSET=EPSG:3857&FORMAT=application/vnd.mapbox-vector-tile&TILECOL={x}&TILEROW={y}']
      });
